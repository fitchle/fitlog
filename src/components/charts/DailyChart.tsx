...
import { ResponsiveContainer, ComposedChart, XAxis, Tooltip, Line, Area, ReferenceArea, ReferenceLine, YAxis } from "recharts";

export default function DailyChart(props: {data: any}) {
